...
<body>
<header><center>
    <h1>DAFTAR ALUMNI POLMED DAN STUDI LANJUTAN</h1>
</header>
    <br>
    <table border="1">
    <thead>
 ...
 <?php
 $no=1;
    $sql = "SELECT * FROM tblmahasiswa INNER JOIN tbstudi ON tblmahasiswa.idmhs = tbstudi.idstudi"; 
