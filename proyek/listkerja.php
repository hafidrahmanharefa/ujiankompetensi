...
<header><center>
 ...
 $no=1;
    ...
    echo "<td>";
    echo "<a href='editkerja.php?idkerja=".$kerja['idkerja']."'>Edit</a> | ";
    echo "<a href='hapuskerja.php?idkerja=".$kerja['idkerja']."'>Hapus</a>";
    echo "</td>";
    echo "</tr>";
}
 ?>
 ...
 <center><a href="index2.php">BERANDA</a><a>|</a><a href="inputkerja.php">TAMBAH</a>
 </body>
</html>