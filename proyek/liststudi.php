...
<header><center>
 ...
 $no=1;
    ...
    echo "<td>";
    echo "<a href='editstudi.php?idstudi=".$studi['idstudi']."'>Edit</a> | ";
    echo "<a href='hapusstudi.php?idstudi=".$studi['idstudi']."'>Hapus</a>";
    echo "</td>";
    echo "</tr>";
}
 ?>
 ...
 <center><a href="index2.php">BERANDA</a><a>|</a><a href="inputstudi.php">TAMBAH</a>
 </body>
</html>